...
/// </summary>
public class ParallelTestCollectionRunner :
	XunitTestCollectionRunnerBase<ParallelTestCollectionRunnerContext, IXunitTestCollection, IXunitTestClass, IXunitTestCase>
{
	/// <summary>
	/// Initializes a new instance of the <see cref="XunitTestCollectionRunner"/> class.
	/// </summary>
	protected ParallelTestCollectionRunner()
	{ }
		...
		FixtureMappingManager assemblyFixtureMappings)
	{
		...
		await using var ctxt = new ParallelTestCollectionRunnerContext(testCollection, testCases, explicitOption, messageBus, testCaseOrderer, aggregator, cancellationTokenSource, assemblyFixtureMappings);
	...
	protected override ValueTask<RunSummary> RunTestClass(
		ParallelTestCollectionRunnerContext ctxt,
		...
		IReadOnlyCollection<IXunitTestCase> testCases)
	{
		...
		return
			ParallelTestClassRunner.Instance.Run(
				testClass,
				testCases,
				ctxt.ExplicitOption,
				ctxt.MessageBus,
