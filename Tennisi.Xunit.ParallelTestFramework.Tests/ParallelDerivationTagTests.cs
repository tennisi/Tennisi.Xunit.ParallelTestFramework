...
public class ParallelDerivationTagTests
{
    ...
    public void ItShouldCorrectlyHandleChainingOperations()
    {
        ...
        var tagX = ParallelTag.FromValue("0000000000000000000000000000000000000000");
        var tagY = ParallelTag.FromValue("0000000000000000000000000000000000000000",0);
        Assert.Equal(tagX, tagY);
